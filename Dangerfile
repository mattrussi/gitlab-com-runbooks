...
key_metrics_changes =
  helper
    .all_changed_files
    .grep(%r{\Alegacy-prometheus-rules/autogenerated-key-metrics-.*\.yml\z})
...
if key_metrics_changes.any?
  warn <<~MESSAGE
    ...
    Most of the time, this is OK, but please check the [autogenerated key metrics documentation](/legacy-prometheus-rules/README.md#autogenerated-key-metrics) and make sure that this won't cause any issues with our overall SLA reporting.
  MESSAGE
end
