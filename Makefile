...
.PHONY: generate-service-catalog-schema-docs
generate-service-catalog-schema-docs:
	npm install
	npm run generate-service-catalog-schema-docs
	rm -rf services/docs/service-catalog-*.md
