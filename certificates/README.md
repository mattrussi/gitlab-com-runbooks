...
| staging.gitlab.com, auth.staging.gitlab.com, geo.staging.gitlab.com, gstg.gitlab.com, git.ci-gateway.int.gstg.gitlab.net | Sectigo RSA Domain Validation Secure Server CA | staging instance | [GKMS][gkms] & [manual Cloudflare][manual_cf] | item: `frontend-loadbalancer gstg`, fields: `gitlab-haproxy.ssl.gitlab_crt`,  `gitlab-haproxy.ssl.gitlab_key` |
