...
- Use [`jsonnetunit`](https://github.com/yugui/jsonnetunit). This method is simple and straight-forward. The downside is that it doesn't support assertion and inspecting complicated result is not trivial.
- Use Rspec. We have two custom matchers for this purpose:
