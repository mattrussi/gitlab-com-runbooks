...
| `about.gitlab.com`                                                                                                                   | GlobalSign CloudSSL CA - SHA256 - G3                                   | CDN Certificate for about.gitlab.com                                                                                                     | [Fastly][fastly]                                    | Auto-renewed shared certificate                                                                                                                                                                     |
...
| `contributors.gitlab.com`                                                                                                            | GlobalSign CloudSSL CA - SHA256 - G3                                   | Redirect to gitlab.biterg.io, hosted on Fastly                                                                                           | [Fastly][fastly]                                    | Auto-renewed shared certificate                                                                                                                                                                     |
...
| `gitlab.org`                                                                                                                         | GlobalSign CloudSSL CA - SHA256 - G3                                   | Redirect to about.gitlab.com, hosted on Fastly                                                                                           | [Fastly][fastly]                                    | Auto-renewed shared certificate                                                                                                                                                                     |
...
| `jobs.gitlab.com`                                                                                                                    | Sectigo RSA Domain Validation Secure Server CA                         | Redirects to <https://about.gitlab.com/jobs/>, Hosted on about-src                                                                       | [Fastly][fastly] & [Chef Vault][chef-vault]         | data bag: `about-gitlab-com`, item: `_default`, fields: `[jobs.gitlab.com][ssl_certificate]`, `[jobs.gitlab.com][ssl_key]`                                                                          |
