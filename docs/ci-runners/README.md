...
| `GCP/gitlab-r-saas-l-m-amd64-gitlab-org-1`  | `ephemeral-runners/ephemeral-runners`       | `10.11.8.0/21`   |
| `GCP/gitlab-r-saas-l-m-amd64-gitlab-org-2`  | `ephemeral-runners/ephemeral-runners`       | `10.xx.x.x/21`   |
| `GCP/gitlab-r-saas-l-m-amd64-gitlab-org-3`  | `ephemeral-runners/ephemeral-runners`       | `10.xx.x.x/21`   |
| `GCP/gitlab-r-saas-l-m-amd64-gitlab-org-4`  | `ephemeral-runners/ephemeral-runners`       | `10.xx.x.x/21`   |
| `GCP/gitlab-r-saas-l-m-amd64-gitlab-org-5`  | `ephemeral-runners/ephemeral-runners`       | `10.xx.x.x/21`   |
| `GCP/gitlab-r-saas-l-m-amd64-gitlab-org-6`  | `ephemeral-runners/ephemeral-runners`       | `10.xx.x.x/21`   |
