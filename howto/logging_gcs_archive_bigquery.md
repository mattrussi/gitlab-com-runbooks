...
5. Insert the bucket URI as follows: `gitlab-gprd-logging-archive/rails.production/2019/01/01/myfile.JSON` for a single file or `gitlab-gprd-logging-archive/rails.production/2019/01/*` for all files in that folder. 
