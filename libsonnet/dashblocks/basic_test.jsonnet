...
local timeseries_basic = import './basic.libsonnet';
...
{
  expected: graph_basic.graphPanel(title, linewidth, fill, datasource, description, decimals, sort, legend_show, legend_values, legend_min, legend_max, legend_current, legend_total, legend_avg, legend_alignAsTable, legend_hideEmpty, legend_rightSide, thresholds, points, pointradius, stableId, lines, stack, bars),
