...
{
  backup_duration(selectorHash, useTimeSeriesPlugin=false)::
  ...
  backup_rpc_status(selectorHash, useTimeSeriesPlugin=false)::
    if useTimeSeriesPlugin then
      panel.timeSeries(
  ...
  backup_rpc_latency(selectorHash, useTimeSeriesPlugin=false)::
    if useTimeSeriesPlugin then
      panel.timeSeries(
  ...
  backup_bundle_upload_rate(selectorHash, useTimeSeriesPlugin=false)::
    if useTimeSeriesPlugin then
      panel.timeSeries(
