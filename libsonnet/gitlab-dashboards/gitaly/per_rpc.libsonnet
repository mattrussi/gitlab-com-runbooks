...
{
  request_rate_by_method(selectorHash, useTimeSeriesPlugin=false)::
  ...
  request_rate_by_code(selectorHash, useTimeSeriesPlugin=false)::
    if useTimeSeriesPlugin then
      panel.timeSeries(
  ...
  in_progress_requests(selectorHash, useTimeSeriesPlugin=false)::
    if useTimeSeriesPlugin then
      panel.timeSeries(
  ...
  queued_requests(selectorHash, useTimeSeriesPlugin=false)::
    if useTimeSeriesPlugin then
      panel.timeSeries(
  ...
  dropped_requests(selectorHash, useTimeSeriesPlugin=false)::
    if useTimeSeriesPlugin then
      panel.timeSeries(
  ...
  queueing_time(selectorHash, useTimeSeriesPlugin=false)::
    if useTimeSeriesPlugin then
      panel.timeSeries(
