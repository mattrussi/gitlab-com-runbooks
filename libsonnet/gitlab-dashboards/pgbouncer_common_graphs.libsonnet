...
{
  workloadStats(serviceType, startRow, useTimeSeriesPlugin=false)::
    local formatConfig = {
  ...
  networkStats(serviceType, startRow, useTimeSeriesPlugin=false)::
    local formatConfig = {
      serviceType: serviceType,
    };
  ...
  connectionPoolingPanels(serviceType, user, startRow, useTimeSeriesPlugin=false)::
