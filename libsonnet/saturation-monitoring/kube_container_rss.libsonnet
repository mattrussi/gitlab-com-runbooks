...
local sidekiqDefinition = commonDefinition {
  appliesTo: ['sidekiq'],
  grafana_dashboard_uid: 'sat_sidekiq_kube_container_rss',
  capacityPlanning: {
    strategy: 'exclude',
  },
};
...
{
  kube_container_rss: resourceSaturationPoint(commonDefinition),
  sidekiq_kube_container_rss: resourceSaturationPoint(sidekiqDefinition),
}
