...
local sidekiqDefinition = commonDefinition {
  appliesTo: ['sidekiq'],
  grafana_dashboard_uid: 'sat_sidekiq_kube_pool_max_nodes',
  capacityPlanning: {
    strategy: 'exclude',
  },
};
...
{
  kube_pool_max_nodes: resourceSaturationPoint(commonDefinition),
  sidekiq_kube_pool_max_nodes: resourceSaturationPoint(sidekiqDefinition),
}
