...
{
  pgbouncer_client_conn_primary: pgbouncer_client_conn(maxClientConns=15000, name='Primary', appliesToServiceTypes=['pgbouncer', 'pgbouncer-registry', 'pgbouncer-embedding', 'pgbouncer-ci']),
  pgbouncer_client_conn_replicas: pgbouncer_client_conn(maxClientConns=30000, name='Replicas', appliesToServiceTypes=['patroni', 'patroni-registry', 'patroni-embedding', 'patroni-ci']),
}
