...

{
  ...
  pgbouncer_client_conn_replicas: pgbouncer_client_conn(maxClientConns=20000, name='Replicas', appliesToServiceTypes=['patroni', 'patroni-registry', 'patroni-ci', 'patroni-ci1']),
}
