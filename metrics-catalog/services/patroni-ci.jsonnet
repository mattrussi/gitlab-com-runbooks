    ...
    additionalServiceLevelIndicators={
      ...
      rails_primary_sql: {
        ...
        apdex: histogramApdex(
          ...
          selector=railsBaseSelector { db_config_name: 'ci' },
        ...
        requestRate: rateMetric(
          ...
          selector=railsBaseSelector { le: '+Inf', db_config_name: 'ci' },
        ),
      ...
      rails_replica_sql: {
        ...
        apdex: histogramApdex(
          ...
          selector=railsBaseSelector { db_config_name: 'ci_replica' },
          satisfiedThreshold=0.05,
          toleratedThreshold=0.1
        ),
        ...
        requestRate: rateMetric(
          ...
          selector=railsBaseSelector { le: '+Inf', db_config_name: 'ci_replica' },
        ),
