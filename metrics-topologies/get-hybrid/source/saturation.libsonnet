local saturationTypes = [
  ...
  // import 'saturation-monitoring/kube_hpa_desired_replicas.libsonnet',
  ...
  import 'saturation-monitoring/praefect_cloudsql_cpu.libsonnet',
  ...
  // import 'saturation-monitoring/sidekiq_shard_workers.libsonnet', // TODO: currently relies on GitLab.com sharding topology
