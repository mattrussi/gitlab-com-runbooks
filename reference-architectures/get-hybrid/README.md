...
| `kube_persistent_volume_claim_disk_space` |  | disk space utilization on persistent volume claims.  | ✅ | 90% |
| `kube_persistent_volume_claim_inodes` |  | inode utilization on persistent volume claims.  | ✅ | 90% |
