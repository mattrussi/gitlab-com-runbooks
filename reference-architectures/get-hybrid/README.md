...
| `webservice` | `workhorse` | Aggregation of most rails requests that pass through workhorse, monitored via the HTTP interface. Excludes known slow requests that typically transfer large amounts of data and are expected to be slower.  | ✅ SLO: 99.8% | ✅ SLO: 99.99% | ✅ |
