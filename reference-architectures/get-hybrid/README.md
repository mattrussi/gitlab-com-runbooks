...
| `kube_persistent_volume_claim_disk_space` | `consul`, `gitlab-shell`, `registry`, `sidekiq`, `webservice` | disk space utilization on persistent volume claims.  | ✅ | 90% |
| `kube_persistent_volume_claim_inodes` | `consul`, `gitlab-shell`, `registry`, `sidekiq`, `webservice` | inode utilization on persistent volume claims.  | ✅ | 90% |
