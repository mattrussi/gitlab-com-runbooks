...
| `sidekiq` | `default` | All other Sidekiq jobs (not in urgent_cpu_bound or urgent_other queues)  | ✅ SLO: 99.5% | ✅ SLO: 99.5% | ✅ |
...
| `sidekiq` | `urgent_cpu_bound` | Sidekiq jobs in the urgent_cpu_bound queue  | ✅ SLO: 99.5% | ✅ SLO: 99.5% | ✅ |
| `sidekiq` | `urgent_other` | Sidekiq jobs in the urgent_other queue  | ✅ SLO: 99.5% | ✅ SLO: 99.5% | ✅ |
| `sidekiq` | `importers` | Sidekiq jobs in the importers queue  | ✅ SLO: 99.5% | ✅ SLO: 99.5% | ✅ |
