...
| `kube_container_memory` | `consul`, `gitlab-shell`, `registry`, `sidekiq`, `webservice` | Records the total memory utilization for containers for this service, as a percentage of the memory limit as configured through Kubernetes.  | ✅ | 90% |
