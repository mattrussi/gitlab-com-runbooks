...
| ------------ | ----------------------- | --------------- | -------------------------- | -----------------------|
| `aws_rds_disk_space` | `rds` | We are fully saturated when we are at 2GB remaining free space, we have no way of knowing the total available space and RDS will autoscale storage for us when we are at 10GB or 10% free space, whichever is greater.  | ✅ | 95% |
