...
// TODO: This file will be removed as part of https://gitlab.com/groups/gitlab-com/gl-infra/-/epics/700
{
  'custom-feature-category-metrics-sidekiq.yml': std.manifestYamlDoc({
    groups: [{
      name: 'Prometheus Intermediate Metrics per feature',
      interval: '1m',
      rules: sidekiqPerWorkerRecordingRules.perWorkerRecordingRulesForAggregationSet(aggregationSets.featureCategorySourceSLIs, { component: 'sidekiq_execution_per_shard' }),
    }],
  }),
}
