...
jsonnet_compile "${SCRIPT_DIR}/../metrics-catalog/gitlab-dashboards.jsonnet"
jsonnet_compile "${SCRIPT_DIR}/../metrics-catalog/gitlab-triage-dashboards.jsonnet"
jsonnet_compile "${SCRIPT_DIR}/../metrics-catalog/gitlab-slas-dashboard.jsonnet"
